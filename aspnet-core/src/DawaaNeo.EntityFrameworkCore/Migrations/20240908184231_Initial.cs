    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BlopName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullMobileNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppVerficationCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPatientAddresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPatientAddresses_AppPatients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationInfo_Latitude = table.Column<double>(type: "float", nullable: false),
                    LocationInfo_Longitude = table.Column<double>(type: "float", nullable: false),
                    LocationInfo_Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LocationInfo_CityId = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProviders_AppCities_LocationInfo_CityId",
                        column: x => x.LocationInfo_CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CretedOn = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DeliveryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeliveryCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AddressId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Instruction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_BuildingName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_AppartmentNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_LandMark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_Longitude = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_Latitude = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAddress_Type = table.Column<int>(type: "int", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppOrders_AppPatients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AppPatients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppOrders_AppProviders_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddingType = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPatientProviders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPatientProviders_AppPatients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AppPatients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppPatientProviders_AppProviders_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "AppProviders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkingTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppWorkingTimes_AppProviders_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "AppProviders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Instruction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsOtc = table.Column<bool>(type: "bit", nullable: false),
                    OrginalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppOrders_PatientId",
                table: "AppOrders",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOrders_ProviderId",
                table: "AppOrders",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPatientAddresses_PatientId",
                table: "AppPatientAddresses",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPatientProviders_PatientId",
                table: "AppPatientProviders",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPatientProviders_ProviderId",
                table: "AppPatientProviders",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProviders_LocationInfo_CityId",
                table: "AppProviders",
                column: "LocationInfo_CityId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkingTimes_ProviderId",
                table: "AppWorkingTimes",
                column: "ProviderId");
