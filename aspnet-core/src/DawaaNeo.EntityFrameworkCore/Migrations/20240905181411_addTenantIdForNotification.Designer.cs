...
namespace DawaaNeo.Migrations
{
    ...
    [Migration("20240905181411_addTenantIdForNotification")]
    partial class addTenantIdForNotification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DawaaNeo.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BlopName")
                        .IsRequired()
            ...
            modelBuilder.Entity("DawaaNeo.Devices.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IconThumbnail")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DawaaNeo.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Otps.Otp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Patients.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Patients.PatientAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPatientAddresses", (string)null);
                });

            modelBuilder.Entity("DawaaNeo.Patients.PatientProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPatientProviders", (string)null);
                });

            modelBuilder.Entity("DawaaNeo.Providers.Provider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProviders", (string)null);
                });

            modelBuilder.Entity("DawaaNeo.Providers.VerficationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppVerficationCodes", (string)null);
                });

            modelBuilder.Entity("DawaaNeo.Providers.WorkingTime", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppWorkingTimes", (string)null);
                });

            modelBuilder.Entity("DawaaNeo.Services.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.SharedDomains.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DawaaNeo.SharedDomains.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DawaaNeo.SharedDomains.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DawaaNeo.Orders.Order", b =>
                {
                    b.HasOne("DawaaNeo.Patients.Patient", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DawaaNeo.Providers.Provider", "Provider")
                        .WithMany()
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("DawaaNeo.Orders.DeliveryAddress", "DeliveryAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("DawaaNeo.Orders.OrderItem", b =>
                {
                    b.HasOne("DawaaNeo.Orders.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
            ...
            modelBuilder.Entity("DawaaNeo.Patients.PatientAddress", b =>
                {
                    b.HasOne("DawaaNeo.Patients.Patient", null)
            ...
            modelBuilder.Entity("DawaaNeo.Providers.Provider", b =>
                {
                    b.OwnsOne("DawaaNeo.Providers.valueObject.ProviderAddress", "LocationInfo", b1 =>
                        {
                            ...
                            b1.ToTable("AppProviders");

                            b1.HasOne("DawaaNeo.SharedDomains.City", "City")
                                .WithMany()
            ...
            modelBuilder.Entity("DawaaNeo.Providers.WorkingTime", b =>
                {
                    b.HasOne("DawaaNeo.Providers.Provider", null)
            ...
            modelBuilder.Entity("DawaaNeo.SharedDomains.City", b =>
                {
                    b.HasOne("DawaaNeo.SharedDomains.Country", null)
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("DawaaNeo.SharedDomains.Country", b =>
                {
                    b.HasOne("DawaaNeo.SharedDomains.Currency", "Currency")
                        .WithMany()
